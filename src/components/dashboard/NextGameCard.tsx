  ...
  return (
    <div className="stat-card">
      <div className="flex items-center justify-between mb-3">
        <h3 className="metric-label">Next Game</h3>
        <span className="status-badge bg-primary/10 text-primary border-primary/20">Upcoming</span>
      </div>
      
      <p className="text-lg font-semibold text-foreground">{game.opponent}</p>
      <p className="text-xs text-muted-foreground mt-1">
        {format(new Date(game.date), 'EEE, MMM d')} &middot; {game.location}
      </p>
